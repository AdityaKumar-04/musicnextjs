    ...
    return (
        <div className='h-auto md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0'>
            ...
            <div className='p-4 relative z-10 w-full text-center'>
                ...
                <p className='mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto'>Dive into our compreshensive music course and
                    transform your musical journey today. Whether
                    your re a beginner or looking to refiner your
